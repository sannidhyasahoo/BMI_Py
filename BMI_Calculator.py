...
if start=='1':
    ...
    if BMI<18.5:
        ...
        print("\n\t",name,", you are having Obesity (Class I)\n")
    elif BMI>=35 and BMI<40:
        print("\n\t",name,",you are having Obesity (Class II)\n")
    elif BMI>=40:
        print("\n\t",name,", you are having Obesity (Class III)\n")
    else:
        print("INVALID INPUT(S) !!! .\nPROGRAM TERMINATED !!!")
ChoicOApp=int(input("\t^_^ Enter 2 if you would like to download BMI Calculator App \n\tOr Enter 3 to view the source code \n\tENTER YOUR CHOICE::"))
import webbrowser
if  ChoicOApp==2:
...
print("if your browser doesn`t open c2opy the above\nlink and paste it on your browser")
print("========================================================================")
